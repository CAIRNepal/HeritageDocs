...
_Daily worship ritual performed continuously_





URI: [heritageGraph:NityaPuja](https://cair-nepal.org/heritageGraph/NityaPuja)
...
```mermaid
 classDiagram
    ...
    click NityaPuja href "../NityaPuja/"
      ...
      NityaPuja : english_description
        
      NityaPuja : follows_tradition
        
          
    
        
        
        NityaPuja --> "0..1" TraditionOrPractice : follows_tradition
        click TraditionOrPractice href "../TraditionOrPractice/"
    

        
      NityaPuja : has_provenance_assertion
        
          
    
        
        
        NityaPuja --> "*" ProvenanceAssertion : has_provenance_assertion
        click ProvenanceAssertion href "../ProvenanceAssertion/"
    

        
      NityaPuja : has_timespan
        
          
    
        
        
        NityaPuja --> "0..1" TimeSpan : has_timespan
        click TimeSpan href "../TimeSpan/"
    

        
      NityaPuja : invokes_deity
        
          
    
        
        
        NityaPuja --> "*" Deity : invokes_deity
        click Deity href "../Deity/"
    

        
      NityaPuja : is_part_of_festival
        
          
    
        
        
        NityaPuja --> "0..1" Festival : is_part_of_festival
        click Festival href "../Festival/"
    

        
      NityaPuja : lunar_date_tithi
        
      NityaPuja : managed_by_guthi
        
          
    
        
        
        NityaPuja --> "*" Guthi : managed_by_guthi
      ...
      NityaPuja : occurs_after
        
          
    
        
        
        NityaPuja --> "0..1" RitualEvent : occurs_after
        click RitualEvent href "../RitualEvent/"
    

        
      NityaPuja : occurs_before
        
          
    
        
        
        NityaPuja --> "0..1" RitualEvent : occurs_before
        click RitualEvent href "../RitualEvent/"
    

        
      NityaPuja : performed_by_actor
        
          
    
        
        
        NityaPuja --> "*" Person : performed_by_actor
        click Person href "../Person/"
    

        
      NityaPuja : performed_by_group
        
          
    
        
        
        NityaPuja --> "*" Guthi : performed_by_group
        click Guthi href "../Guthi/"
    

        
      NityaPuja : recurrence_pattern
        
      NityaPuja : ritual_on_structure
        
          
    
        
        
        NityaPuja --> "0..1" ArchitecturalStructure : ritual_on_structure
        click ArchitecturalStructure href "../ArchitecturalStructure/"
    

        
      NityaPuja : ritual_type
        
          
    
        
        
        NityaPuja --> "0..1" RitualTypeEnum : ritual_type
        click RitualTypeEnum href "../RitualTypeEnum/"
    

        
      NityaPuja : used_materials
        
          
    
        
        
        NityaPuja --> "*" Material : used_materials
        click Material href "../Material/"
    

        
      NityaPuja : was_documented_by
        
          
    
        
        
        NityaPuja --> "*" DocumentationActivity : was_documented_by
...
| ---  | ---  |
| self | heritageGraph:NityaPuja |
| native | heritageGraph:NityaPuja |
...
```yaml
name: NityaPuja
description: Daily worship ritual performed continuously
