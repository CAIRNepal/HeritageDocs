...
_Pilgrim lodge operated by a Guthi organization_





URI: [heritageGraph:Dharmashala](https://cair-nepal.org/heritageGraph/Dharmashala)
...
```mermaid
 classDiagram
    ...
    click Dharmashala href "../Dharmashala/"
      ...
      Dharmashala : english_description
        
      Dharmashala : has_component
        
          
    
        
        
        Dharmashala --> "*" ArchitecturalElement : has_component
        click ArchitecturalElement href "../ArchitecturalElement/"
    

        
      Dharmashala : has_condition_assessment
        
          
    
        
        
        Dharmashala --> "*" ConditionAssessment : has_condition_assessment
        click ConditionAssessment href "../ConditionAssessment/"
    

        
      Dharmashala : has_current_location
        
          
    
        
        
        Dharmashala --> "1" Place : has_current_location
        click Place href "../Place/"
    

        
      Dharmashala : has_custody_event
        
          
    
        
        
        Dharmashala --> "*" TransferOfCustody : has_custody_event
      ...
      Dharmashala : participates_in_ritual
        
          
    
        
        
        Dharmashala --> "*" RitualEvent : participates_in_ritual
        click RitualEvent href "../RitualEvent/"
    

        
      Dharmashala : was_documented_by
        
          
    
        
        
        Dharmashala --> "*" DocumentationActivity : was_documented_by
        click DocumentationActivity href "../DocumentationActivity/"
    

        
      Dharmashala : was_produced_by_event
        
          
    
        
        
        Dharmashala --> "0..1" Production : was_produced_by_event
...
| ---  | ---  |
| self | heritageGraph:Dharmashala |
| native | heritageGraph:Dharmashala |
