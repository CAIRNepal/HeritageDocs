...
_Music and dance trust (nāsaḥdyaḥ) preserving ritual performance traditions_





URI: [heritageGraph:NashaGuthi](https://cair-nepal.org/heritageGraph/NashaGuthi)
...
```mermaid
 classDiagram
    ...
    click NashaGuthi href "../NashaGuthi/"
      ...
      NashaGuthi : english_description
        
      NashaGuthi : founded_by_event
        
          
    
        
        
        NashaGuthi --> "0..1" Production : founded_by_event
        click Production href "../Production/"
    

        
      NashaGuthi : guthi_type
        
          
    
        
        
        NashaGuthi --> "0..1" GuthiTypeEnum : guthi_type
        click GuthiTypeEnum href "../GuthiTypeEnum/"
    

        
      NashaGuthi : has_land_endowment
        
      NashaGuthi : has_membership
        
          
    
        
        
        NashaGuthi --> "*" Person : has_membership
        click Person href "../Person/"
    

        
      NashaGuthi : holds_custody_of
        
          
    
        
        
        NashaGuthi --> "*" ArchitecturalStructure : holds_custody_of
        click ArchitecturalStructure href "../ArchitecturalStructure/"
    

        
      NashaGuthi : manages_structure
        
          
    
        
        
        NashaGuthi --> "*" ArchitecturalStructure : manages_structure
        click ArchitecturalStructure href "../ArchitecturalStructure/"
      ...
      NashaGuthi : performs_ritual
        
          
    
        
        
        NashaGuthi --> "*" RitualEvent : performs_ritual
...
| ---  | ---  |
| self | heritageGraph:NashaGuthi |
| native | heritageGraph:NashaGuthi |
...
```yaml
name: NashaGuthi
description: Music and dance trust (nāsaḥdyaḥ) preserving ritual performance traditions
from_schema: CulturalHeritageOntology
is_a: Guthi
class_uri: heritageGraph:NashaGuthi
