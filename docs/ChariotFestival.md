...
_Festival involving ceremonial chariot procession (e.g., Rato Machhindranath Jatra)_





URI: [heritageGraph:ChariotFestival](https://cair-nepal.org/heritageGraph/ChariotFestival)
...
```mermaid
 classDiagram
    ...
    click ChariotFestival href "../ChariotFestival/"
      ...
      ChariotFestival : english_description
        
      ChariotFestival : follows_tradition
        
          
    
        
        
        ChariotFestival --> "0..1" TraditionOrPractice : follows_tradition
        click TraditionOrPractice href "../TraditionOrPractice/"
    

        
      ChariotFestival : has_provenance_assertion
        
          
    
        
        
        ChariotFestival --> "*" ProvenanceAssertion : has_provenance_assertion
        click ProvenanceAssertion href "../ProvenanceAssertion/"
    

        
      ChariotFestival : has_timespan
        
          
    
        
        
        ChariotFestival --> "0..1" TimeSpan : has_timespan
        click TimeSpan href "../TimeSpan/"
    

        
      ChariotFestival : includes_ritual_event
        
          
    
        
        
        ChariotFestival --> "*" RitualEvent : includes_ritual_event
        click RitualEvent href "../RitualEvent/"
    

        
      ChariotFestival : invokes_deity
        
          
    
        
        
        ChariotFestival --> "*" Deity : invokes_deity
        click Deity href "../Deity/"
    

        
      ChariotFestival : is_part_of_festival
        
          
    
        
        
        ChariotFestival --> "0..1" Festival : is_part_of_festival
        click Festival href "../Festival/"
    

        
      ChariotFestival : lunar_date_tithi
        
      ChariotFestival : managed_by_guthi
        
          
    
        
        
        ChariotFestival --> "*" Guthi : managed_by_guthi
        click Guthi href "../Guthi/"
    

        
      ChariotFestival : name
        
      ChariotFestival : occurs_after
        
          
    
        
        
        ChariotFestival --> "0..1" RitualEvent : occurs_after
        click RitualEvent href "../RitualEvent/"
    

        
      ChariotFestival : occurs_before
        
          
    
        
        
        ChariotFestival --> "0..1" RitualEvent : occurs_before
        click RitualEvent href "../RitualEvent/"
    

        
      ChariotFestival : performed_by_actor
        
          
    
        
        
        ChariotFestival --> "*" Person : performed_by_actor
        click Person href "../Person/"
    

        
      ChariotFestival : performed_by_group
        
          
    
        
        
        ChariotFestival --> "*" Guthi : performed_by_group
        click Guthi href "../Guthi/"
    

        
      ChariotFestival : recurrence_pattern
        
      ChariotFestival : ritual_on_structure
        
          
    
        
        
        ChariotFestival --> "0..1" ArchitecturalStructure : ritual_on_structure
        click ArchitecturalStructure href "../ArchitecturalStructure/"
    

        
      ChariotFestival : ritual_type
        
          
    
        
        
        ChariotFestival --> "0..1" RitualTypeEnum : ritual_type
        click RitualTypeEnum href "../RitualTypeEnum/"
    

        
      ChariotFestival : used_materials
        
          
    
        
        
        ChariotFestival --> "*" Material : used_materials
        click Material href "../Material/"
    

        
      ChariotFestival : was_documented_by
        
          
    
        
        
        ChariotFestival --> "*" DocumentationActivity : was_documented_by
...
| ---  | ---  |
| self | heritageGraph:ChariotFestival |
| native | heritageGraph:ChariotFestival |
...
<details>
```yaml
name: ChariotFestival
description: Festival involving ceremonial chariot procession (e.g., Rato Machhindranath
  Jatra)
