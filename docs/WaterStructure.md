...
_Engineered water supply systems with ritual and civic significance_





URI: [heritageGraph:WaterStructure](https://cair-nepal.org/heritageGraph/WaterStructure)
...
```mermaid
 classDiagram
    ...
    click WaterStructure href "../WaterStructure/"
      ...
      WaterStructure : english_description
        
      WaterStructure : has_component
        
          
    
        
        
        WaterStructure --> "*" ArchitecturalElement : has_component
        click ArchitecturalElement href "../ArchitecturalElement/"
    

        
      WaterStructure : has_condition_assessment
        
          
    
        
        
        WaterStructure --> "*" ConditionAssessment : has_condition_assessment
        click ConditionAssessment href "../ConditionAssessment/"
    

        
      WaterStructure : has_current_location
        
          
    
        
        
        WaterStructure --> "1" Place : has_current_location
        click Place href "../Place/"
    

        
      WaterStructure : has_custody_event
        
          
    
        
        
        WaterStructure --> "*" TransferOfCustody : has_custody_event
      ...
      WaterStructure : participates_in_ritual
        
          
    
        
        
        WaterStructure --> "*" RitualEvent : participates_in_ritual
        click RitualEvent href "../RitualEvent/"
    

        
      WaterStructure : was_documented_by
        
          
    
        
        
        WaterStructure --> "*" DocumentationActivity : was_documented_by
        click DocumentationActivity href "../DocumentationActivity/"
    

        
      WaterStructure : was_produced_by_event
        
          
    
        
        
        WaterStructure --> "0..1" Production : was_produced_by_event
...
| ---  | ---  |
| self | heritageGraph:WaterStructure |
| native | heritageGraph:WaterStructure |
