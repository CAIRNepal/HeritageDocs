...
_Festival trust responsible for organizing and funding annual Jatra events_





URI: [heritageGraph:JatraGuthi](https://cair-nepal.org/heritageGraph/JatraGuthi)
...
```mermaid
 classDiagram
    ...
    click JatraGuthi href "../JatraGuthi/"
      ...
      JatraGuthi : english_description
        
      JatraGuthi : founded_by_event
        
          
    
        
        
        JatraGuthi --> "0..1" Production : founded_by_event
        click Production href "../Production/"
    

        
      JatraGuthi : guthi_type
        
          
    
        
        
        JatraGuthi --> "0..1" GuthiTypeEnum : guthi_type
        click GuthiTypeEnum href "../GuthiTypeEnum/"
    

        
      JatraGuthi : has_land_endowment
        
      JatraGuthi : has_membership
        
          
    
        
        
        JatraGuthi --> "*" Person : has_membership
        click Person href "../Person/"
    

        
      JatraGuthi : holds_custody_of
        
          
    
        
        
        JatraGuthi --> "*" ArchitecturalStructure : holds_custody_of
        click ArchitecturalStructure href "../ArchitecturalStructure/"
    

        
      JatraGuthi : manages_structure
        
          
    
        
        
        JatraGuthi --> "*" ArchitecturalStructure : manages_structure
        click ArchitecturalStructure href "../ArchitecturalStructure/"
      ...
      JatraGuthi : performs_ritual
        
          
    
        
        
        JatraGuthi --> "*" RitualEvent : performs_ritual
...
| ---  | ---  |
| self | heritageGraph:JatraGuthi |
| native | heritageGraph:JatraGuthi |
...
```yaml
name: JatraGuthi
description: Festival trust responsible for organizing and funding annual Jatra events
from_schema: CulturalHeritageOntology
is_a: Guthi
class_uri: heritageGraph:JatraGuthi
