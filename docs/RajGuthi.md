...
_Royal Guthi established by Malla or Shah monarchy (pre-1964)_





URI: [heritageGraph:RajGuthi](https://cair-nepal.org/heritageGraph/RajGuthi)
...
```mermaid
 classDiagram
    ...
    click RajGuthi href "../RajGuthi/"
      ...
      RajGuthi : english_description
        
      RajGuthi : founded_by_event
        
          
    
        
        
        RajGuthi --> "0..1" Production : founded_by_event
      ...
      RajGuthi : guthi_type
        ...
        RajGuthi --> "0..1" GuthiTypeEnum : guthi_type
        click GuthiTypeEnum href "../GuthiTypeEnum/"
    

        
      RajGuthi : has_land_endowment
        
      RajGuthi : has_membership
        
          
    
        
        
        RajGuthi --> "*" Person : has_membership
        click Person href "../Person/"
    

        
      RajGuthi : holds_custody_of
        
          
    
        
        
        RajGuthi --> "*" ArchitecturalStructure : holds_custody_of
        click ArchitecturalStructure href "../ArchitecturalStructure/"
    

        
      RajGuthi : manages_structure
        
          
    
        
        
        RajGuthi --> "*" ArchitecturalStructure : manages_structure
        click ArchitecturalStructure href "../ArchitecturalStructure/"
      ...
      RajGuthi : performs_ritual
        
          
    
        
        
        RajGuthi --> "*" RitualEvent : performs_ritual
...
| ---  | ---  |
| self | heritageGraph:RajGuthi |
| native | heritageGraph:RajGuthi |
...
```yaml
name: RajGuthi
description: Royal Guthi established by Malla or Shah monarchy (pre-1964)
from_schema: CulturalHeritageOntology
is_a: Guthi
class_uri: heritageGraph:RajGuthi
