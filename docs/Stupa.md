...
_Buddhist dome-shaped reliquary shrine (e.g., Boudhanath, Swayambhunath)_





URI: [heritageGraph:Stupa](https://cair-nepal.org/heritageGraph/Stupa)
 ...
 classDiagram
    ...
    click Stupa href "../Stupa/"
      ...
      Stupa : has_component
        ...
        Stupa --> "*" ArchitecturalElement : has_component
        click ArchitecturalElement href "../ArchitecturalElement/"
    

        
      Stupa : has_condition_assessment
        
          
    
        
        
        Stupa --> "*" ConditionAssessment : has_condition_assessment
        click ConditionAssessment href "../ConditionAssessment/"
    

        
      Stupa : has_current_location
        
          
    
        
        
        Stupa --> "1" Place : has_current_location
        click Place href "../Place/"
    

        
      Stupa : has_custody_event
        
          
    
        
        
        Stupa --> "*" TransferOfCustody : has_custody_event
      ...
      Stupa : participates_in_ritual
        
          
    
        
        
        Stupa --> "*" RitualEvent : participates_in_ritual
        click RitualEvent href "../RitualEvent/"
    

        
      Stupa : was_documented_by
        
          
    
        
        
        Stupa --> "*" DocumentationActivity : was_documented_by
        click DocumentationActivity href "../DocumentationActivity/"
    

        
      Stupa : was_produced_by_event
        
          
    
        
        
        Stupa --> "0..1" Production : was_produced_by_event
...
| ---  | ---  |
| self | heritageGraph:Stupa |
| native | heritageGraph:Stupa |
...
```yaml
name: Stupa
description: Buddhist dome-shaped reliquary shrine (e.g., Boudhanath, Swayambhunath)
