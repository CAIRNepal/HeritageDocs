...
_Life-cycle ritual trust managing rites of passage_





URI: [heritageGraph:SanGuthi](https://cair-nepal.org/heritageGraph/SanGuthi)
...
```mermaid
 classDiagram
    ...
    click SanGuthi href "../SanGuthi/"
      ...
      SanGuthi : english_description
        
      SanGuthi : founded_by_event
        
          
    
        
        
        SanGuthi --> "0..1" Production : founded_by_event
      ...
      SanGuthi : guthi_type
        ...
        SanGuthi --> "0..1" GuthiTypeEnum : guthi_type
        click GuthiTypeEnum href "../GuthiTypeEnum/"
    

        
      SanGuthi : has_land_endowment
        
      SanGuthi : has_membership
        
          
    
        
        
        SanGuthi --> "*" Person : has_membership
        click Person href "../Person/"
    

        
      SanGuthi : holds_custody_of
        
          
    
        
        
        SanGuthi --> "*" ArchitecturalStructure : holds_custody_of
        click ArchitecturalStructure href "../ArchitecturalStructure/"
    

        
      SanGuthi : manages_structure
        
          
    
        
        
        SanGuthi --> "*" ArchitecturalStructure : manages_structure
        click ArchitecturalStructure href "../ArchitecturalStructure/"
      ...
      SanGuthi : performs_ritual
        
          
    
        
        
        SanGuthi --> "*" RitualEvent : performs_ritual
...
| ---  | ---  |
| self | heritageGraph:SanGuthi |
| native | heritageGraph:SanGuthi |
...
```yaml
name: SanGuthi
description: Life-cycle ritual trust managing rites of passage
from_schema: CulturalHeritageOntology
is_a: Guthi
class_uri: heritageGraph:SanGuthi
