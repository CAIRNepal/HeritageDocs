...
_Points to the prerequisite ritual._





URI: [crm:P120i_is_occurred_before_by](http://www.cidoc-crm.org/cidoc-crm/P120i_is_occurred_before_by)
Alias: occurs_after
...
| ---  | ---  |
| self | crm:P120i_is_occurred_before_by |
| native | heritageGraph:occurs_after |
