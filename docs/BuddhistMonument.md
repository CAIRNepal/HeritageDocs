...
# Class: BuddhistMonument 


_Buddhist sacred structure (Stupa, Chaitya) with circumambulation and ritual activation patterns_





URI: [heritageGraph:BuddhistMonument](https://cair-nepal.org/heritageGraph/BuddhistMonument)
 ...
 classDiagram
    ...
    click BuddhistMonument href "../BuddhistMonument/"
      ...
      BuddhistMonument <|-- Stupa
        click Stupa href "../Stupa/"
      BuddhistMonument <|-- Chaitya
        click Chaitya href "../Chaitya/"
      

      BuddhistMonument : english_description
        
      BuddhistMonument : has_component
        
          
    
        
        
        BuddhistMonument --> "*" ArchitecturalElement : has_component
        click ArchitecturalElement href "../ArchitecturalElement/"
    

        
      BuddhistMonument : has_condition_assessment
        
          
    
        
        
        BuddhistMonument --> "*" ConditionAssessment : has_condition_assessment
        click ConditionAssessment href "../ConditionAssessment/"
    

        
      BuddhistMonument : has_current_location
        
          
    
        
        
        BuddhistMonument --> "1" Place : has_current_location
        click Place href "../Place/"
    

        
      BuddhistMonument : has_custody_event
        
          
    
        
        
        BuddhistMonument --> "*" TransferOfCustody : has_custody_event
        click TransferOfCustody href "../TransferOfCustody/"
    

        
      BuddhistMonument : name
        
      BuddhistMonument : participates_in_ritual
        
          
    
        
        
        BuddhistMonument --> "*" RitualEvent : participates_in_ritual
        click RitualEvent href "../RitualEvent/"
    

        
      BuddhistMonument : was_documented_by
        
          
    
        
        
        BuddhistMonument --> "*" DocumentationActivity : was_documented_by
        click DocumentationActivity href "../DocumentationActivity/"
    

        
      BuddhistMonument : was_produced_by_event
        
          
    
        
        
        BuddhistMonument --> "0..1" Production : was_produced_by_event
...
| ---  | ---  |
| self | heritageGraph:BuddhistMonument |
| native | heritageGraph:BuddhistMonument |
...
<details>
```yaml
name: BuddhistMonument
description: Buddhist sacred structure (Stupa, Chaitya) with circumambulation and
  ritual activation patterns
from_schema: CulturalHeritageOntology
is_a: ArchitecturalStructure
class_uri: heritageGraph:BuddhistMonument
