...
_Funeral trust responsible for death rituals and cremation ceremonies_





URI: [heritageGraph:SiGuthi](https://cair-nepal.org/heritageGraph/SiGuthi)
...
```mermaid
 classDiagram
    ...
    click SiGuthi href "../SiGuthi/"
      ...
      SiGuthi : english_description
        
      SiGuthi : founded_by_event
        
          
    
        
        
        SiGuthi --> "0..1" Production : founded_by_event
      ...
      SiGuthi : guthi_type
        ...
        SiGuthi --> "0..1" GuthiTypeEnum : guthi_type
        click GuthiTypeEnum href "../GuthiTypeEnum/"
    

        
      SiGuthi : has_land_endowment
        
      SiGuthi : has_membership
        
          
    
        
        
        SiGuthi --> "*" Person : has_membership
        click Person href "../Person/"
    

        
      SiGuthi : holds_custody_of
        
          
    
        
        
        SiGuthi --> "*" ArchitecturalStructure : holds_custody_of
        click ArchitecturalStructure href "../ArchitecturalStructure/"
    

        
      SiGuthi : manages_structure
        
          
    
        
        
        SiGuthi --> "*" ArchitecturalStructure : manages_structure
        click ArchitecturalStructure href "../ArchitecturalStructure/"
      ...
      SiGuthi : performs_ritual
        
          
    
        
        
        SiGuthi --> "*" RitualEvent : performs_ritual
...
| ---  | ---  |
| self | heritageGraph:SiGuthi |
| native | heritageGraph:SiGuthi |
...
```yaml
name: SiGuthi
description: Funeral trust responsible for death rituals and cremation ceremonies
from_schema: CulturalHeritageOntology
is_a: Guthi
class_uri: heritageGraph:SiGuthi
