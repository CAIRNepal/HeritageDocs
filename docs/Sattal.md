...
_Multi-story rest house (3-5 floors) with ritual and social functions_





URI: [heritageGraph:Sattal](https://cair-nepal.org/heritageGraph/Sattal)
...
```mermaid
 classDiagram
    ...
    click Sattal href "../Sattal/"
      ...
      Sattal : english_description
        
      Sattal : has_component
        
          
    
        
        
        Sattal --> "*" ArchitecturalElement : has_component
        click ArchitecturalElement href "../ArchitecturalElement/"
    

        
      Sattal : has_condition_assessment
        
          
    
        
        
        Sattal --> "*" ConditionAssessment : has_condition_assessment
        click ConditionAssessment href "../ConditionAssessment/"
    

        
      Sattal : has_current_location
        
          
    
        
        
        Sattal --> "1" Place : has_current_location
        click Place href "../Place/"
    

        
      Sattal : has_custody_event
        
          
    
        
        
        Sattal --> "*" TransferOfCustody : has_custody_event
      ...
      Sattal : participates_in_ritual
        
          
    
        
        
        Sattal --> "*" RitualEvent : participates_in_ritual
        click RitualEvent href "../RitualEvent/"
    

        
      Sattal : was_documented_by
        
          
    
        
        
        Sattal --> "*" DocumentationActivity : was_documented_by
        click DocumentationActivity href "../DocumentationActivity/"
    

        
      Sattal : was_produced_by_event
        
          
    
        
        
        Sattal --> "0..1" Production : was_produced_by_event
...
| ---  | ---  |
| self | heritageGraph:Sattal |
| native | heritageGraph:Sattal |
