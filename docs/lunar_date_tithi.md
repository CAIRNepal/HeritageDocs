...
# Slot: lunar_date_tithi 


_Lunar day (Tithi) for ritual timing_





URI: [heritageGraph:lunar_date_tithi](https://cair-nepal.org/heritageGraph/lunar_date_tithi)
...
| ---  | ---  |
| self | heritageGraph:lunar_date_tithi |
| native | heritageGraph:lunar_date_tithi |
